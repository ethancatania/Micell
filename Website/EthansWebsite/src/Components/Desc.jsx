...
const Desc = function() {
    return (
        <div className="desc">
             <p className='wpi'> I am a proud graduate of Worcester Polytechnic Institute, where I earned my bachelor's degree in computer science and graduated with distinction honors.
